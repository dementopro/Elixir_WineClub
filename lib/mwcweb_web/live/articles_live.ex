defmodule MwcwebWeb.ArticlesLive do
  ...
  def render_article(socket, %{id: _id, slug: _slug} = article,counter ) do
    Phoenix.View.render(MwcwebWeb.PageView, "article.html", socket: socket, article: article , counter: counter)
  end
  ...
  defp fetch_articles do
    with {:ok, articles} <- Mwcweb.articles() do
      articles
